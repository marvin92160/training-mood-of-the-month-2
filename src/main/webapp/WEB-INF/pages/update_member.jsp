                                ...
                                <div class="col-xs-12">
                                    <form action="/projet/update_member" method="post" class="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="input-lg form-control" id="email" name="email" placeholder="Email Address" value="${email_old}">
                                        </div>
                                        <div class="form-group">
                                            <label for="date">Birthdate</label>
                                            <input type="date" class="input-lg form-control" id="birthdate" name="birthdate" placeholder="DD/MM/YYYY" value="${birthdate_old}">
                                        </div>
